...
import (
	...
	"github.com/acudac-com/gcsjwt"
	"github.com/golang-jwt/jwt"
)

func init() {
	if err := gcsjwt.Init("auth.packagedev.acudac.com"); err != nil {
		panic(err)
	}
}
...
func TestSignedJwt(t *testing.T) {
	...
	if err := gcsjwt.Validate(ctx, signedJwt); err != nil {
...
func TestInvalidJwt(t *testing.T) {
	...
	if err := gcsjwt.Validate(ctx, invalidJwt); err == nil {
